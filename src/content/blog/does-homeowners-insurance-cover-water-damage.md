...
generated_at: "2026-08-26T01:53:23.303428+00:00"
...
faq: [{"question": "If I file a water damage claim, will my homeowners insurance premium go up?", "answer": "It can, yes \u2014 and this is a legitimate factor to weigh before filing. Many carriers use a claims database called CLUE (Comprehensive Loss Underwriting Exchange) that tracks claims history for both the policyholder and the property address. A single claim may or may not trigger a rate increase depending on your carrier, your claims history, and the size of the loss. If the damage estimate is close to your deductible, it may make financial sense to pay out of pocket and preserve your claims record. Talk to your agent before deciding \u2014 they can tell you how your specific carrier handles it."}, {"question": "Does homeowners insurance cover mold that resulted from water damage?", "answer": "It depends on whether the underlying water event was covered. If a burst pipe caused the water damage and mold grew as a result, many policies will cover mold remediation up to a sublimit \u2014 often $5,000 to $10,000, though limits vary widely by policy. If the mold grew from a slow leak that wasn't covered, the mold remediation typically isn't covered either. Some carriers offer mold endorsements that raise the sublimit; it's worth checking your declarations page to see what yours says."}, {"question": "What's the difference between water damage and flood damage for insurance purposes?", "answer": "The distinction is about the *direction* and *source* of the water. Water damage, in insurance terms, originates from inside the home \u2014 a plumbing failure, an appliance, or rain entering through a storm-damaged roof. Flood damage is water that comes from outside and moves overland before entering the structure \u2014 rising rivers, storm surge, or sheet flow across a yard. Standard homeowners policies exclude flooding; you need a separate flood policy for that. In parts of Ventura County with coastal exposure or proximity to river channels, flood coverage is worth evaluating separately."}, {"question": "Can I do my own water damage cleanup instead of hiring a restoration company?", "answer": "For a very minor spill on a hard surface, yes. For anything involving carpet, drywall, insulation, subfloor, or water that sat for more than a few hours, DIY cleanup carries real risk \u2014 not because the work is technically impossible, but because it's very difficult to confirm materials are dry without moisture meters, and incomplete drying is the primary cause of mold growth after a water event. If you're filing an insurance claim, carriers also expect professional documentation of the drying process, which you can't produce with fans and a wet-vac."}]
...
## What Standard HO-3 Policies Usually Cover
...
## What Policies Almost Never Cover

Understanding the exclusions is just as important as knowing the coverage, because these are the situations where homeowners get surprised.
...
## How to Document a Claim Before the Adjuster Arrives

If you've had a sudden water event, how you document it in the first hours matters as much as the damage itself. Here's a practical sequence:

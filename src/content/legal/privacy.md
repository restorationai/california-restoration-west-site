---
archetype: "legal"
title: "Privacy Policy | California Restoration West "
h1: "Privacy Policy"
meta_description: "Privacy Policy | {brand.display_name}."
primary_keyword: "california restoration west  privacy"
secondary_keywords: []
search_intent: "navigational_legal"
priority: 1.0
plan_hash: "ade2e597bbc7d2dc"
generated_at: "2026-08-26T02:00:02.366718+00:00"
...
The only circumstance in which your information is shared with an outside party is when you explicitly authorize us to coordinate with your insurance company or a third-party administrator. That authorization is documented in your signed work-authorization form. Outside of that, your information stays with us.

We may be required to disclose information if compelled by law, court order, or a valid government request.
...
*Note on GDPR: Our services are limited to California. If you are located in the European Union and have a privacy concern, you may contact us and we will address it in good faith, though formal GDPR obligations are unlikely to apply to our operations.*

---

## Contact for Privacy Questions

If you have a question or concern about how your information is handled, reach us directly:
...
We provide restoration services in Ventura County and surrounding areas of California. Requests outside our service area may be declined or referred to a qualified contractor closer to your property.
...
Accepted payment methods and due dates are specified in your signed work-authorization form. When we are coordinating directly with your insurance carrier, payment timelines follow the carrier's claim process. Any portion not covered by insurance remains the property owner's responsibility as outlined in the authorization.

### Liability

California Restoration West operates as a licensed contractor under California state regulations. Our liability is limited to the scope of work described in the signed authorization. We are not responsible for pre-existing conditions, code violations unrelated to the loss, or damage caused by delayed reporting of a loss.
...
If a dispute arises from a service relationship, we ask that you contact us directly first so we have the opportunity to resolve it. If a resolution cannot be reached, disputes are subject to the laws of the State of California and the jurisdiction of Ventura County courts.
